...
public class Main {
	 ...
	 * - command line: java -cp bin Main "Lab1Temp.map" 5 10 20
	...
	public static void main(String[] args) {
		try {
			...
			String tsimCommand = String.format("tsim --speed=%d %s", tsim_speed, map);
			...
			new Lab1Temp(train1_speed, train2_speed);
			// new Lab2(train1_speed, train2_speed);
			p.waitFor();
			
		} catch (ArrayIndexOutOfBoundsException e) {
			System.err.println("Main method expects 3-4 arguments: Lab1Temp.map <Train1Speed> <Train2Speed> [SimulatorSpeed]");
		} catch (IOException e) {
			e.printStackTrace();
